...
| `medication[x]:medicationReference` | Medikation[x] | Definition eines Medikamentes zum Zwecke der Verschreibung, Abgabe und Verabreichung. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | Medikation (Verweis) | Verweis auf die Medikament-Ressource. |  |
| `medication[x]:medicationCodeableConcept` | Medikation[x] | Definition eines Medikamentes zum Zwecke der Verschreibung, Abgabe und Verabreichung. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | Medikation (Code) | Inline-Kodierung der Medikation. |  |
| `medication[x]:medicationCodeableConcept.coding:Pharmazentralnummer` | Medikation[x] | Definition eines Medikamentes zum Zwecke der Verschreibung, Abgabe und Verabreichung. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | Pharmazentralnummer | Kodierung nach Pharmazentralnummer. |  |
| `medication[x]:medicationCodeableConcept.coding:atcClassDe` | Medikation[x] | Definition eines Medikamentes zum Zwecke der Verschreibung, Abgabe und Verabreichung. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | ATC (BfArM) | Kodierung nach ATC (BfArM). |  |
| `medication[x]:medicationCodeableConcept.coding:atcClassEn` | Medikation[x] | Definition eines Medikamentes zum Zwecke der Verschreibung, Abgabe und Verabreichung. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | ATC (WHO) | Kodierung nach ATC (WHO). |  |
| `medication[x]:medicationCodeableConcept.coding:UNII` | Medikation[x] | Definition eines Medikamentes zum Zwecke der Verschreibung, Abgabe und Verabreichung. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | UNII | Kodierung nach UNII. |  |
...
| `dosage.rate[x]:rateRatio` | Dosierung | Details zur Dosierung der Medikation | Verabreichungsrate (Verhältnis) | Verabreichungsrate als Verhältnis (z.B. mg / Stunde). |  |
| `dosage.rate[x]:rateQuantity` | Dosierung | Details zur Dosierung der Medikation | Verabreichungsrate (Quantität) | Verabreichungsrate als Quantität. |  |
...
| `medication[x]:medicationReference` | Medikation[x] | Medikament, welches angeordnet wird. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | Medikation (Verweis) | Verweis auf die Medikament-Ressource. |  |
| `medication[x]:medicationCodeableConcept` | Medikation[x] | Medikament, welches angeordnet wird. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | Medikation (Code) | Inline-Kodierung der Medikation. |  |
| `medication[x]:medicationCodeableConcept.coding:Pharmazentralnummer` | Medikation[x] | Medikament, welches angeordnet wird. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | Pharmazentralnummer | Kodierung nach Pharmazentralnummer. |  |
| `medication[x]:medicationCodeableConcept.coding:atcClassDe` | Medikation[x] | Medikament, welches angeordnet wird. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | ATC (BfArM) | Kodierung nach ATC (BfArM). |  |
| `medication[x]:medicationCodeableConcept.coding:atcClassEn` | Medikation[x] | Medikament, welches angeordnet wird. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | ATC (WHO) | Kodierung nach ATC (WHO). |  |
| `medication[x]:medicationCodeableConcept.coding:UNII` | Medikation[x] | Medikament, welches angeordnet wird. Es kann sich um ein fertiges Arzneimittelprodukt, einen Wirkstoff oder eine Rezeptur handeln. | UNII | Kodierung nach UNII. |  |
...
| `dosageInstruction.asNeeded[x]:asNeededBoolean` | Dosierungsinstruktionen | Anweisungen, wie das Medikament eingenommen werden soll. | Bei Bedarf | Gibt an, ob die Medikation nur bei Bedarf eingenommen wird. |  |
| `dosageInstruction.asNeeded[x]:asNeededCodeableConcept` | Dosierungsinstruktionen | Anweisungen, wie das Medikament eingenommen werden soll. | Bei Bedarf (Begründung) | Bei Bedarf mit kodierter Begründung. |  |
...
| `dosage.asNeeded[x]:asNeededBoolean` | Dosierung | Gibt an, wie das Medikament vom Patienten eingenommen wird/wurde oder werden soll. | Bei Bedarf | Gibt an, ob die Medikation nur bei Bedarf eingenommen wird. |  |
| `dosage.asNeeded[x]:asNeededCodeableConcept` | Dosierung | Gibt an, wie das Medikament vom Patienten eingenommen wird/wurde oder werden soll. | Bei Bedarf (Begründung) | Bei Bedarf mit kodierter Begründung. |  |
...
| `code.coding:Pharmazentralnummer` | Code | Ein Code (oder eine Reihe von Codes), die dieses Medikament spezifizieren, oder eine Textbeschreibung, wenn kein Code verfügbar ist. | Pharmazentralnummer | Kodierung nach Pharmazentralnummer. |  |
| `code.coding:atcClassDe` | Code | Ein Code (oder eine Reihe von Codes), die dieses Medikament spezifizieren, oder eine Textbeschreibung, wenn kein Code verfügbar ist. | ATC (BfArM) | Kodierung nach ATC (BfArM). |  |
| `code.coding:atcClassEn` | Code | Ein Code (oder eine Reihe von Codes), die dieses Medikament spezifizieren, oder eine Textbeschreibung, wenn kein Code verfügbar ist. | ATC (WHO) | Kodierung nach ATC (WHO). |  |
...
| `code.coding:medCode` | Typ | Definiert den Typ der Liste - warum diese erstellt wurde. | List Use Code | Kodierung nach List Use Code. |
| `code.coding:contextCode` | Typ | Definiert den Typ der Liste - warum diese erstellt wurde. | Fallkontext | Kodierung nach Fallkontext. |
...
| `code.coding:Pharmazentralnummer` | PZN | Coding in PZN. |
| `code.coding:atcClassDe` | ATC (BfArM) | Coding in ATC (BfArM). |
| `code.coding:atcClassEn` | ATC (WHO) | Coding in ATC (WHO). |
...
| `code.coding:medCode` | List Use Code | Coding in List Use Code. |
| `code.coding:contextCode` | Encounter context | Coding in Encounter context. |
| `subject` | Patient | The patient that the resource relates to. |
