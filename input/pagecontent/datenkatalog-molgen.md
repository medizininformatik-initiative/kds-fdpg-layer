...
| `code` | ZuTestendeGene | Code | Code der angeforderten Untersuchung |
...
| `authoredOn` | DatumDerAnforderung | Anforderungsdatum | Datum der Anforderung |
| `requester` |  | Anforderer | Die Person oder Organisation die den Test anfordert |
| `reasonCode` | Indikation | Indikation | Die Indikation oder der Grund für die Testanforderung |
| `reasonReference` | Indikation | Referenz zur Indikation | Referenz zu Diagnosen oder Beobachtungen die die Anforderung begründen |
| `supportingInfo` | Gesundheitszustand | Unterstützende Informationen | Zusätzliche Informationen die die Anforderung unterstützen |
| `note` | Bemerkungen | Anmerkung | Zusätzliche Anmerkungen oder Anforderungstext |
...
| `component` | GetesteteGene, Referenzsequenz, ... | Komponenten | Einzelne Komponenten der diagnostischen Implikation |
| `component:conclusion-string` | GetesteteGene, Referenzsequenz, ... | Schlussfolgerung - Text | Textuelle Zusammenfassung der diagnostischen Implikation |
| `component:evidence-level` | GetesteteGene, Referenzsequenz, ... | Evidenzlevel | Das Evidenzlevel für die klinische Signifikanz |
| `component:clinical-significance` | GetesteteGene, Referenzsequenz, ... | Klinische Signifikanz | Die klinische Signifikanz der Variante wie z.B. pathogen oder benigne |
| `component:predicted-phenotype` | GetesteteGene, Referenzsequenz, ... | Vorhergesagter Phänotyp | Der mit der Variante assoziierte vorhergesagte Phänotyp oder Erkrankung |
| `component:mode-of-inheritance` | GetesteteGene, Referenzsequenz, ... | Vererbungsmodus | Der Vererbungsmodus der assoziierten Erkrankung |
...
| `code` | Empfehlungen, Medikationsempfehlung | Code | Code der empfohlenen Maßnahme |
...
| `effective[x]` |  | Zeitpunkt der Beobachtung | Klinisch relevanter Zeitpunkt der Beobachtung |
| `issued` |  | Freigabedatum | Datum und Uhrzeit der Freigabe |
| `value[x]` | Zusammenfassung, Mikrosatelliteninstabilitaet | Ergebniswert | Der Genotyp als kodierter Wert oder Text |
| `derivedFrom` |  | Abgeleitet von | Die Varianten oder Haplotypen von denen der Genotyp abgeleitet wurde |
| `component` | GetesteteGene, Referenzsequenz, ... | Komponenten | Einzelne Komponenten des Genotyps |
| `component:conclusion-string` | GetesteteGene, Referenzsequenz, ... | Schlussfolgerung - Text | Textuelle Zusammenfassung des Genotyps |
| `component:gene-studied` | GetesteteGene, Referenzsequenz, ... | Untersuchtes Gen | Das untersuchte Gen identifiziert durch HGNC-ID |
| `component:cytogenetic-location` | GetesteteGene, Referenzsequenz, ... | Zytogenetische Lokalisation | Chromosomale Position in Bandennomenklatur |
| `component:reference-sequence-assembly` | GetesteteGene, Referenzsequenz, ... | Referenzgenom-Assembly | Die verwendete Referenzgenom-Version |
...
| `intent` |  | Absicht | Die Absicht der Aufgabe wie z.B. Vorschlag |
| `code` | Empfehlungen, Medikationsempfehlung | Code | Code der Medikationsempfehlung |
...
| `effective[x]` |  | Zeitpunkt der Beobachtung | Klinisch relevanter Zeitpunkt der Beobachtung |
| `issued` |  | Freigabedatum | Datum und Uhrzeit der Freigabe |
| `value[x]` | Zusammenfassung, Mikrosatelliteninstabilitaet | Ergebniswert | Das Ergebnis der MSI-Bestimmung wie z.B. stabil oder instabil |
| `derivedFrom` |  | Abgeleitet von | Referenzen zu anderen Beobachtungen von denen diese abgeleitet ist |
| `component` | GetesteteGene, Referenzsequenz, ... | Komponenten | Einzelne Komponenten der Beobachtung |
| `component:gene-studied` | GetesteteGene, Referenzsequenz, ... | Untersuchtes Gen | Das untersuchte Gen |
| `component:biomarker-category` | GetesteteGene, Referenzsequenz, ... | Biomarker-Kategorie | Die Kategorie des molekularen Biomarkers |
...
| `component` | GetesteteGene, Referenzsequenz, ... | Komponenten | Einzelne Komponenten der molekularen Konsequenz |
| `component:conclusion-string` | GetesteteGene, Referenzsequenz, ... | Schlussfolgerung - Text | Textuelle Zusammenfassung der molekularen Konsequenz |
| `component:evidence-level` | GetesteteGene, Referenzsequenz, ... | Evidenzlevel | Das Evidenzlevel für die molekulare Konsequenz |
| `component:clinical-significance` | GetesteteGene, Referenzsequenz, ... | Klinische Signifikanz | Die klinische Signifikanz der Variante |
| `component:functional-effect` | GetesteteGene, Referenzsequenz, ... | Funktioneller Effekt | Der funktionelle Effekt der Variante auf das Genprodukt |
...
| `extension:workflow-relatedArtifact` |  | Verknüpfte Artefakte | Verknüpfte Literatur oder andere Artefakte wie Zitationen |
| `status` | Berichtstatus | Status | Status des Befundberichts |
...
| `issued` | DatumDesBerichts | Freigabedatum | Datum und Uhrzeit der Freigabe des Berichts |
...
| `effective[x]` |  | Zeitpunkt der Beobachtung | Klinisch relevanter Zeitpunkt der Beobachtung |
| `issued` |  | Freigabedatum | Datum und Uhrzeit der Freigabe |
| `value[x]` | Zusammenfassung, Mikrosatelliteninstabilitaet | Ergebniswert | Der numerische Wert der Mutationslast in Mutationen pro Megabase |
...
| `component` | GetesteteGene, Referenzsequenz, ... | Komponenten | Einzelne Komponenten der therapeutischen Implikation |
| `component:conclusion-string` | GetesteteGene, Referenzsequenz, ... | Schlussfolgerung - Text | Textuelle Zusammenfassung der therapeutischen Implikation |
| `component:evidence-level` | GetesteteGene, Referenzsequenz, ... | Evidenzlevel | Das Evidenzlevel für die therapeutische Empfehlung |
| `component:therapeutic-implication` | GetesteteGene, Referenzsequenz, ... | Art der therapeutischen Implikation | Die Art der therapeutischen Implikation wie z.B. Sensitivität oder Resistenz |
| `component:phenotypic-treatment-context` | GetesteteGene, Referenzsequenz, ... | Phänotypischer Behandlungskontext | Der phänotypische oder krankheitsbezogene Kontext der Behandlung |
| `component:medication-assessed` | GetesteteGene, Referenzsequenz, ... | Bewertete Medikation | Die bewertete Medikation für die therapeutische Empfehlung |
| `component:therapy-assessed` | GetesteteGene, Referenzsequenz, ... | Bewertete Therapie | Die bewertete nicht-medikamentöse Therapie |
...
| `value[x]` | Zusammenfassung, Mikrosatelliteninstabilitaet | Ergebniswert | Das Ergebnis der Variantenanalyse - vorhanden oder abwesend |
| `method` | Methode | Methode | Die verwendete Untersuchungsmethode |
| `specimen` |  | Probe | Die untersuchte Probe |
| `device` |  | Gerät | Das verwendete Analysegerät |
| `component:conclusion-string` | GetesteteGene, Referenzsequenz, ... | Schlussfolgerung - Text | Textuelle Zusammenfassung oder Schlussfolgerung zur Variante |
| `component:gene-studied` | GetesteteGene, Referenzsequenz, ... | Untersuchtes Gen | Das untersuchte Gen identifiziert durch HGNC-ID |
| `component:cytogenetic-location` | GetesteteGene, Referenzsequenz, ... | Zytogenetische Lokalisation | Chromosomale Position der Variante in Bandennomenklatur |
| `component:reference-sequence-assembly` | GetesteteGene, Referenzsequenz, ... | Referenzgenom-Assembly | Die verwendete Referenzgenom-Version wie z.B. GRCh37 oder GRCh38 |
| `component:chromosome-identifier` | GetesteteGene, Referenzsequenz, ... | Chromosom | Das betroffene Chromosom |
| `component:representative-coding-hgvs` | GetesteteGene, Referenzsequenz, ... | DNA-Änderung c.HGVS | Die cDNA-Änderung in HGVS-Nomenklatur auf Transkriptebene |
| `component:genomic-hgvs` | GetesteteGene, Referenzsequenz, ... | Genomische DNA-Änderung g.HGVS | Die genomische DNA-Änderung in HGVS-Nomenklatur |
| `component:genomic-ref-seq` | GetesteteGene, Referenzsequenz, ... | Genomische Referenzsequenz | Die genomische Referenzsequenz-ID wie z.B. NC_000007.14 |
| `component:representative-transcript-ref-seq` | GetesteteGene, Referenzsequenz, ... | Transkript-Referenzsequenz | Die Transkript-Referenzsequenz-ID wie z.B. NM_004333.4 |
| `component:exact-start-end` | GetesteteGene, Referenzsequenz, ... | Exakte Start-End-Position | Die exakten genomischen Koordinaten der Variante - Start und Ende |
| `component:inner-start-end` | GetesteteGene, Referenzsequenz, ... | Innere Start-End-Position | Der innere Bereich bei strukturellen Varianten |
| `component:outer-start-end` | GetesteteGene, Referenzsequenz, ... | Äußere Start-End-Position | Der äußere Bereich bei strukturellen Varianten |
| `component:ref-allele` | GetesteteGene, Referenzsequenz, ... | Referenz-Allel | Die Nukleotidsequenz des Referenz-Allels |
| `component:alt-allele` | GetesteteGene, Referenzsequenz, ... | Alternatives Allel | Die Nukleotidsequenz des alternativen - mutierten - Allels |
| `component:coding-change-type` | GetesteteGene, Referenzsequenz, ... | DNA-Änderungstyp | Der Typ der DNA-Änderung wie z.B. Substitution oder Deletion |
| `component:genomic-source-class` | GetesteteGene, Referenzsequenz, ... | Genomische Herkunftsklasse | Die Herkunft der Variante wie z.B. somatisch oder Keimbahn |
| `component:sample-allelic-frequency` | GetesteteGene, Referenzsequenz, ... | Allelfrequenz in der Probe | Die Häufigkeit des varianten Allels in der untersuchten Probe |
| `component:allelic-read-depth` | GetesteteGene, Referenzsequenz, ... | Allelische Lesetiefe | Die Anzahl der Reads die das Allel unterstützen |
| `component:allelic-state` | GetesteteGene, Referenzsequenz, ... | Allelstatus | Der Allelstatus wie z.B. heterozygot oder homozygot |
| `component:variant-inheritance` | GetesteteGene, Referenzsequenz, ... | Varianten-Vererbung | Die Vererbungsart der Variante wie z.B. maternal oder paternal |
| `component:variation-code` | GetesteteGene, Referenzsequenz, ... | Varianten-Code | Eindeutiger Identifikator der Variante aus externen Datenbanken wie z.B. ClinVar oder dbSNP |
| `component:representative-protein-hgvs` | GetesteteGene, Referenzsequenz, ... | Aminosäure-Änderung p.HGVS | Die Aminosäure-Änderung in HGVS-Nomenklatur auf Proteinebene |
| `component:copy-number` | GetesteteGene, Referenzsequenz, ... | Kopienzahl | Die Anzahl der Kopien eines genomischen Abschnitts |
| `component:variant-confidence-status` | GetesteteGene, Referenzsequenz, ... | Konfidenzstatus der Variante | Der Vertrauensstatus der Variantendetektion |
| `component:dna-region` | GetesteteGene, Referenzsequenz, ... | DNA-Regionsname | Ein lesbarer Name für die untersuchte Region. Typischerweise Exon # oder Intron # oder andere. |
| `component:gene-fusion` | GetesteteGene, Referenzsequenz, ... | Genfusion | Details zur Genfusion in Blut oder Gewebe mittels molekulargenetischer Methode |
| `component:detection-limit` | GetesteteGene, Referenzsequenz, ... | Nachweisgrenze | Die Nachweisgrenze des Laborgeräts |
