...
* partOf ^definition = "Verweis auf übergeordnetes Medium"
...
* status ^definition = "Status des Mediums"
...
* type ^definition = "Typ des Mediums"
...
* modality ^definition = "Bildgebungsmodalität"
