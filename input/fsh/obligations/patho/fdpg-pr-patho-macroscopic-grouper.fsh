Profile: FDPG_PR_Patho_Macroscopic_Grouper
Parent: MII_PR_Patho_Macroscopic_Grouper
...
* insert Translation(^title, de-DE, Makroskopischer Grouper)
* insert Translation(^title, en-US, Macroscopic grouper)
