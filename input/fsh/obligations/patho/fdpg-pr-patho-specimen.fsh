...
// Specimen.identifier:Placer-ID.value
...
// Specimen.identifier:Filler-ID.value
* identifier[Filler-ID].value ^short = "The value that is unique"
// Specimen.accessionIdentifier
* accessionIdentifier ^short = "Labor-ID"
...
* collection.method ^short = "Entnahmemethode"
* insert Translation(collection.method ^short, de-DE, Entnahmemethode)
* insert Translation(collection.method ^short, en-US, Collection method)
* collection.method ^definition = "Methode der Probenentnahme"
* insert Translation(collection.method ^definition, de-DE, Methode der Probenentnahme)
* insert Translation(collection.method ^definition, en-US, Method of specimen collection)
