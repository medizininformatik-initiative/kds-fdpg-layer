...
* insert Translation(^title, de-DE, Diagnostische Schlussfolgerung (Grouper\))
...
* insert ObligationConsumerDefault(derivedFrom[grouper-observation])
* insert ObligationConsumerDefault(derivedFrom[questionnaire-response])
