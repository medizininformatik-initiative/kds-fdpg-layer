Profile: FDPG_PR_Patho_Additional_Specified_Grouper
Parent: MII_PR_Patho_Additional_Specified_Grouper
...
* insert Translation(^title, de-DE, Weiterer spezifizierter Grouper)
