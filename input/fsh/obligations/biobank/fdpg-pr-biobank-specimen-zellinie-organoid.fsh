...
Id: fdpg-pr-biobank-specimen-zellinie-organoid
...
* insert ObligationConsumerDefault(extension[kulturprotokoll])
* insert ObligationConsumerDefault(extension[modifikationen])
* insert ObligationConsumerDefault(extension[anzahlPassagen])
