...
Description: "FDPG Profil - MII_PR_ICU_Bilanz_Ausfuhr_Magensonde"
* insert FDPGMetadata
* insert FDPGModule(icu)
* insert Translation(^title, de-DE, Bilanz - Ausfuhr Magensonde)
* insert Translation(^title, en-US, Fluid Balance - Nasogastric Tube Output)
