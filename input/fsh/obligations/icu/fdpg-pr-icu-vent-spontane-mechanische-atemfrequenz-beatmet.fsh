...
* insert FDPGMetadata
* insert Translation(^title, de-DE, Spontane + mechanische Atemfrequenz (beatmet\))
* insert Translation(^title, en-US, Spontaneous Plus Mechanical Respiratory Rate (Ventilated\))
