...
Id: fdpg-pr-icu-dynamische-kompliance
Title: "FDPG PR ICU Dynamische Kompliance"
Description: "FDPG Profil - MII_PR_ICU_Dynamische_Kompliance"
* insert FDPGMetadata
* insert Translation(^title, de-DE, MII PR ICU Dynamische Kompliance)
* insert Translation(^title, en-US, FDPG PR ICU Dynamische Kompliance)
