Profile: FDPG_PR_ICU_Gasfluss
Parent: MII_PR_ICU_Gasfluss
Id: fdpg-pr-icu-gasfluss
Title: "FDPG PR ICU Gasfluss"
Description: "FDPG Profil - MII_PR_ICU_Gasfluss"
* insert FDPGMetadata
* insert Translation(^title, de-DE, MII PR ICU Gasfluss)
* insert Translation(^title, en-US, FDPG PR ICU Gasfluss)
