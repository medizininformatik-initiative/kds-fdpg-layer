...
Id: fdpg-pr-icu-druckdifferenz-beatmung
Title: "FDPG PR ICU Druckdifferenz Beatmung"
Description: "FDPG Profil - MII_PR_ICU_Druckdifferenz_Beatmung"
* insert FDPGMetadata
* insert Translation(^title, de-DE, MII PR ICU Druckdifferenz Beatmung)
* insert Translation(^title, en-US, FDPG PR ICU Druckdifferenz Beatmung)
