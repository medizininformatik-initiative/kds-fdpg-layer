...
* insert FDPGMetadata
* insert Translation(^title, de-DE, MII PR ICU Bilanz Abnahme Haemofiltration Einzelmesswerte)
* insert Translation(^title, en-US, FDPG PR ICU Bilanz Abnahme Haemofiltration Einzelmesswerte)
