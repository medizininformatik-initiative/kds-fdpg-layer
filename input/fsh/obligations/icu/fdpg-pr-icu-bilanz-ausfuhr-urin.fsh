...
Description: "FDPG Profil - MII_PR_ICU_Bilanz_Ausfuhr_Urin"
* insert FDPGMetadata
* insert FDPGModule(icu)
* insert Translation(^title, de-DE, Bilanz - Ausfuhr Urin)
* insert Translation(^title, en-US, Fluid Balance - Urine Output)
