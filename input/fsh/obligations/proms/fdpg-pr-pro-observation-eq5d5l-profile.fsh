...
* insert Translation(^title, de-DE, EQ-5D-5L Profil)
* insert Translation(^title, en-US, EQ-5D-5L Profile)
...
* value[x] ^definition = "String representation of the 5 dimension responses, where each digit represents the level chosen for that dimension (1-5)"
