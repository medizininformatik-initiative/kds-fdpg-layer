Profile: FDPG_PR_PRO_PROMIS_29_Social_Function_TScore
Parent: MII_PR_PRO_PROMIS_29_Social_Function_TScore
Id: fdpg-pr-pro-promis-29-social-function-tscore
...
* insert Translation(^title, de-DE, PROMIS-29 Soziale Funktion T-Score)
* insert Translation(^title, en-US, PROMIS-29 Social Function T-Score)
