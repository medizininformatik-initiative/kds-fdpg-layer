Profile: FDPG_PR_PRO_Observation_EQ5D5L_VAS
Parent: MII_PR_PRO_Observation_EQ5D5L_VAS
Id: fdpg-pr-pro-observation-eq5d5l-vas
Title: "FDPG PR PRO Observation EQ5D5L VAS"
Description: "FDPG Profil - MII_PR_PRO_Observation_EQ5D5L_VAS"
* insert FDPGMetadata
* insert FDPGModule(proms)
* insert Translation(^title, de-DE, EQ-5D-5L Visuelle Analogskala (VAS\))
