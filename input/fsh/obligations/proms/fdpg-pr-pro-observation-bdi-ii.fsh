Profile: FDPG_PR_PRO_Observation_BDI_II
Parent: MII_PR_PRO_Observation_BDI_II
Id: fdpg-pr-pro-observation-bdi-ii
Title: "FDPG PR PRO Observation BDI II"
Description: "FDPG Profil - MII_PR_PRO_Observation_BDI_II"
* insert FDPGMetadata
* insert FDPGModule(proms)
* insert Translation(^title, de-DE, Beck-Depressions-Inventar (BDI-II\))
* insert Translation(^title, en-US, Beck Depression Inventory (BDI-II\))
