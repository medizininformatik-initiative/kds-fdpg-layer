Profile: FDPG_PR_PRO_PROMIS_29_Fatigue_TScore
Parent: MII_PR_PRO_PROMIS_29_Fatigue_TScore
Id: fdpg-pr-pro-promis-29-fatigue-tscore
Title: "FDPG PR PRO PROMIS 29 Fatigue TScore"
Description: "FDPG Profil - MII_PR_PRO_PROMIS_29_Fatigue_TScore"
* insert FDPGMetadata
* insert Translation(^title, de-DE, MII PR PRO PROMIS-29 Fatigue T-Score)
* insert Translation(^title, en-US, FDPG PR PRO PROMIS 29 Fatigue TScore)
