Profile: FDPG_PR_PRO_PROMIS_29_Pain_Intensity
Parent: MII_PR_PRO_PROMIS_29_Pain_Intensity
Id: fdpg-pr-pro-promis-29-pain-intensity
...
* insert Translation(^title, de-DE, PROMIS-29 Schmerzintensität)
* insert Translation(^title, en-US, PROMIS-29 Pain Intensity)
