Profile: FDPG_PR_MTB_Immunohistochemistry
Parent: MII_PR_MTB_Immunohistochemistry
Id: fdpg-pr-mtb-immunohistochemistry
Title: "FDPG PR MTB Immunohistochemistry"
Description: "FDPG Profil - MII_PR_MTB_Immunohistochemistry"
* insert FDPGMetadata
* insert FDPGModule(mtb)
* insert Translation(^title, de-DE, Immunhistochemie)
* insert Translation(^title, en-US, Immunohistochemistry)
