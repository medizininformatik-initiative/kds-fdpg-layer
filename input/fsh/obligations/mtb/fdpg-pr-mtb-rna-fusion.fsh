...
* insert Translation(component[five-prime-transcript-id] ^short, en-US, 5' transcript identifier)
...
* insert Translation(component[five-prime-exon-id] ^short, en-US, 5' exon identifier)
...
* insert Translation(component[five-prime-strand] ^short, en-US, 5' strand)
...
* insert Translation(component[three-prime-transcript-id] ^short, en-US, 3' transcript identifier)
...
* insert Translation(component[three-prime-exon-id] ^short, en-US, 3' exon identifier)
...
* insert Translation(component[three-prime-strand] ^short, en-US, 3' strand)
