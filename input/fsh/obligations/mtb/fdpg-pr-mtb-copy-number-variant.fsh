...
* insert Translation(component[relative-copy-number] ^short, en-US, Relative copy number)
...
* insert Translation(component[relative-copy-number] ^definition, en-US, Relative copy number.)
...
* insert Translation(component[cna] ^short, en-US, CNA)
* component[cna] ^definition = "Copy Number Allel A"
* insert Translation(component[cna] ^definition, de-DE, Kopienzahl Allel A)
* insert Translation(component[cna] ^definition, en-US, Copy number of allele A.)
...
* insert Translation(component[cnb] ^short, en-US, CNB)
* component[cnb] ^definition = "Copy Number Allel B"
* insert Translation(component[cnb] ^definition, de-DE, Kopienzahl Allel B)
* insert Translation(component[cnb] ^definition, en-US, Copy number of allele B.)
...
* insert Translation(component[reported-focality] ^short, en-US, Reported focality)
...
* insert Translation(component[reported-focality] ^definition, en-US, Reported focality.)
...
* insert Translation(component[cnv-type] ^short, en-US, CNV type)
...
* insert Translation(component[cnv-type] ^definition, en-US, Copy number variant type.)
...
* insert Translation(component[copy-number-neutral-loh] ^short, en-US, Copy-number-neutral LoH)
...
* insert Translation(component[copy-number-neutral-loh] ^definition, en-US, Copy-number-neutral loss of heterozygosity.)
