Profile: FDPG_PR_MTB_DNA_Fusion
Parent: MII_PR_MTB_DNA_Fusion
Id: fdpg-pr-mtb-dna-fusion
Title: "FDPG PR MTB DNA Fusion"
Description: "FDPG Profil - MII_PR_MTB_DNA_Fusion"
* insert FDPGMetadata
* insert FDPGModule(mtb)
* insert Translation(^title, de-DE, MII PR MTB DNA Fusion)
* insert Translation(^title, en-US, FDPG PR MTB DNA Fusion)
...
// Observation.component:five-prime-chromosome
...
* insert Translation(component[five-prime-chromosome] ^short, en-US, 5' domain — chromosome)
// Observation.component:five-prime-chromosome.value[x]:valueCodeableConcept
* component[five-prime-chromosome].value[x][valueCodeableConcept] ^short = "Actual component result"
// Observation.component:three-prime-chromosome
...
* insert Translation(component[three-prime-chromosome] ^short, en-US, 3' domain — chromosome)
// Observation.component:three-prime-chromosome.code
* component[three-prime-chromosome].code ^short = "Type of component observation (code / type)"
// Observation.component:three-prime-chromosome.value[x]:valueCodeableConcept
* component[three-prime-chromosome].value[x][valueCodeableConcept] ^short = "Actual component result"
...
* insert Translation(component[five-prime-position] ^short, en-US, 5' domain — position)
// Observation.component:five-prime-position.code
* component[five-prime-position].code ^short = "Type of component observation (code / type)"
...
* insert Translation(component[three-prime-position] ^short, en-US, 3' domain — position)
// Observation.component:three-prime-position.code
* component[three-prime-position].code ^short = "Type of component observation (code / type)"
...
* insert Translation(component[five-prime-gene] ^short, en-US, 5' domain — gene)
// Observation.component:five-prime-gene.code
* component[five-prime-gene].code ^short = "Type of component observation (code / type)"
...
* insert Translation(component[three-prime-gene] ^short, en-US, 3' domain — gene)
// Observation.component:three-prime-gene.code
* component[three-prime-gene].code ^short = "Type of component observation (code / type)"
...
* insert ObligationConsumerDefault(component[five-prime-chromosome])
* insert ObligationConsumerDefault(component[five-prime-chromosome].value[x][valueCodeableConcept])
* insert ObligationConsumerDefault(component[three-prime-chromosome])
* insert ObligationConsumerDefault(component[three-prime-chromosome].value[x][valueCodeableConcept])
