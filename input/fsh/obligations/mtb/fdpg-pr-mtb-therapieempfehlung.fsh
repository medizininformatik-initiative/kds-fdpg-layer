Profile: FDPG_PR_MTB_Therapieempfehlung
Parent: MII_PR_MTB_Therapieempfehlung
Id: fdpg-pr-mtb-therapieempfehlung
...
* insert Translation(^title, en-US, Systemic therapy recommendation)
...
* supportingInformation ^short = "Information to support ordering of the medication"
...
* insert ObligationConsumerDefault(reasonReference[StuetzendeMolekulareAlteration])
