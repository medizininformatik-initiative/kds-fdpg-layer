Profile: FDPG_PR_Mikrobio_Titer
Parent: MII_PR_Mikrobio_Titer
Id: fdpg-pr-mikrobio-titer
Title: "FDPG PR Mikrobio Titer"
Description: "FDPG Profil - MII_PR_Mikrobio_Titer"
* insert FDPGMetadata
* insert Translation(^title, de-DE, MII PR Mikrobio Titer)
* insert Translation(^title, en-US, FDPG PR Mikrobio Titer)
...
* value[x][valueRatio].numerator ^short = "Numerator value"
// Observation.value[x]:valueRatio.denominator
* value[x][valueRatio].denominator ^short = "Denominator value"
// Observation.value[x]:valueRatio.denominator.value
* value[x][valueRatio].denominator.value ^short = "Numerical value (with implicit precision)"
