...
* insert Translation(^title, en-US, FDPG PR Onkologie Abstand Circumferelle Resektionsebene)
...
// Translations
* insert Translation(Observation.code ^short, de-DE, Minimaler Abstand Tumorrand circumferell - makroskopisch oder mikroskopisch)
