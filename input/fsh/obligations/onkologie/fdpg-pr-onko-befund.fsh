...
* code.coding[pathology-report] ^short = "LOINC coding"
* insert Translation(code.coding[pathology-report] ^short, de-DE, LOINC-Kodierung)
* insert Translation(code.coding[pathology-report] ^short, en-US, LOINC coding)
