...
* insert FDPGMetadata
* insert Translation(^title, de-DE, MII PR Onkologie Anzahl der untersuchten Lymphknoten)
* insert Translation(^title, en-US, FDPG PR Onkologie Anzahl der untersuchten Lymphknoten)
...
// Translations
* insert Translation(Observation.value[x] ^short, de-DE, Anzahl untersuchter Lymphknoten)
