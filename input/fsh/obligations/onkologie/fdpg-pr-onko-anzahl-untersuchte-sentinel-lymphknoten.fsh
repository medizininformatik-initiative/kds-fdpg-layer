...
* insert Translation(^title, en-US, FDPG PR Onkologie Anzahl der untersuchten Sentinel-Lymphknoten)
...
// Translations
* insert Translation(Observation.value[x].value ^short, de-DE, Anzahl untersuchter Sentinel-Lymphknoten)
