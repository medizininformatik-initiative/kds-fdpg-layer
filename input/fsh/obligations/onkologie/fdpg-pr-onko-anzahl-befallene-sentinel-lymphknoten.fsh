...
* insert Translation(^title, en-US, FDPG PR Onkologie Anzahl der befallenen Sentinel-Lymphknoten)
...
// Translations
* insert Translation(Observation.value[x] ^short, de-DE, Anzahl befallener Sentinel-Lymphknoten)
