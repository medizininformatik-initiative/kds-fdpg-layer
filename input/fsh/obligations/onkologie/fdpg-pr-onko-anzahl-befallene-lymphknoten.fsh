...
// Observation.value[x]
* value[x] ^short = "Anzahl befallener Lymphknoten"
* insert Translation(value[x] ^short, de-DE, Anzahl befallener Lymphknoten)
* value[x] ^definition = "Anzahl befallener Lymphknoten nach 6.8 oBDS 2021"
* insert Translation(value[x] ^definition, de-DE, Anzahl befallener Lymphknoten nach 6.8 oBDS 2021)
